...
public class MethodInfoAssertionSpecs
{
    ...
    {
        [Fact]
        public async Task When_asserting_a_method_is_virtual_and_it_is_then_it_succeeds()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_asserting_a_method_is_virtual_but_it_is_not_then_it_throws_with_a_useful_message()
        {
            // Arrange
    ...
    {
        [Fact]
        public async Task When_asserting_a_method_is_not_virtual_and_it_is_not_then_it_succeeds()
        {
            // Arrange
            MethodInfo methodInfo = typeof(ClassWithNonVirtualPublicMethods).GetParameterlessMethod("PublicDoNothing");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_not_virtual_but_it_is_then_it_throws_with_a_useful_message()
        {
            // Arrange
            MethodInfo methodInfo = typeof(ClassWithAllMethodsVirtual).GetParameterlessMethod("PublicVirtualDoNothing");
    ...
    {
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_attribute_and_it_is_it_succeeds()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_MethodImpl_attribute_and_it_is_it_succeeds()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_asserting_a_constructor_is_decorated_with_MethodImpl_attribute_and_it_is_it_succeeds()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_MethodImpl_attribute_and_it_is_not_it_throws()
        {
            // Arrange
            MethodInfo methodInfo =
                typeof(ClassWithAllMethodsDecoratedWithDummyAttribute).GetParameterlessMethod("PublicDoNothing");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_MethodImpl_attribute_with_no_options_and_it_is_it_throws()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_MethodImpl_attribute_with_zero_as_options_and_it_is_it_throws()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_asserting_a_class_is_decorated_with_MethodImpl_attribute_and_it_is_not_it_throws()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_an_attribute_but_it_is_not_it_throws_with_a_useful_message()
        {
            // Arrange
            MethodInfo methodInfo =
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_attribute_matching_a_predicate_and_it_is_it_succeeds()
        {
            // Arrange
            MethodInfo methodInfo =
                typeof(ClassWithAllMethodsDecoratedWithDummyAttribute).GetParameterlessMethod("PublicDoNothing");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_MethodImpl_attribute_matching_a_predicate_and_it_is_it_succeeds()
        {
            // Arrange
            MethodInfo methodInfo = typeof(ClassWithMethodWithImplementationAttribute).GetParameterlessMethod("DoNotInlineMe");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_an_attribute_matching_a_predicate_but_it_is_not_it_throws_with_a_useful_message()
        {
            // Arrange
            MethodInfo methodInfo =
                typeof(ClassWithMethodsThatAreNotDecoratedWithDummyAttribute).GetParameterlessMethod("PublicDoNothing");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_an_MethodImpl_attribute_matching_a_predicate_but_it_is_not_it_throws()
        {
            // Arrange
            MethodInfo methodInfo = typeof(ClassWithMethodWithImplementationAttribute).GetParameterlessMethod("DoNotInlineMe");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_decorated_with_an_attribute_and_multiple_attributes_match_continuation_using_the_matched_value_should_fail()
        {
            // Arrange
            MethodInfo methodInfo =
    ...
    {
        [Fact]
        public async Task When_asserting_a_method_is_not_decorated_with_attribute_and_it_is_not_it_succeeds()
        {
            // Arrange
            MethodInfo methodInfo =
                typeof(ClassWithMethodsThatAreNotDecoratedWithDummyAttribute).GetParameterlessMethod("PublicDoNothing");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_not_decorated_with_MethodImpl_attribute_and_it_is_not_it_succeeds()
        {
            // Arrange
            MethodInfo methodInfo =
                typeof(ClassWithMethodsThatAreNotDecoratedWithDummyAttribute).GetParameterlessMethod("PublicDoNothing");
        ...
        [Fact]
        public async Task When_asserting_a_constructor_is_not_decorated_with_MethodImpl_attribute_and_it_is_not_it_succeeds()
        {
            // Arrange
            ConstructorInfo constructorMethodInfo =
        ...
        [Fact]
        public async Task When_asserting_a_method_is_not_decorated_with_an_attribute_but_it_is_it_throws_with_a_useful_message()
        {
            // Arrange
            MethodInfo methodInfo =
                typeof(ClassWithAllMethodsDecoratedWithDummyAttribute).GetParameterlessMethod("PublicDoNothing");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_not_decorated_with_MethodImpl_attribute_and_it_is_it_throws()
        {
            // Arrange
            MethodInfo methodInfo = typeof(ClassWithMethodWithImplementationAttribute).GetParameterlessMethod("DoNotInlineMe");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_not_decorated_with_attribute_matching_a_predicate_and_it_is_not_it_succeeds()
        {
            // Arrange
            MethodInfo methodInfo =
                typeof(ClassWithAllMethodsDecoratedWithDummyAttribute).GetParameterlessMethod("PublicDoNothing");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_not_decorated_with_an_attribute_matching_a_predicate_but_it_is_it_throws_with_a_useful_message()
        {
            // Arrange
            MethodInfo methodInfo =
                typeof(ClassWithAllMethodsDecoratedWithDummyAttribute).GetParameterlessMethod("PublicDoNothing");
    ...
    {
        [Fact]
        public async Task When_asserting_a_method_is_async_and_it_is_then_it_succeeds()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_asserting_a_method_is_async_but_it_is_not_then_it_throws_with_a_useful_message()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_subject_is_null_be_async_should_fail()
        {
            // Arrange
            MethodInfo methodInfo = null;
    ...
    {
        [Fact]
        public async Task When_asserting_a_method_is_not_async_and_it_is_not_then_it_succeeds()
        {
            // Arrange
            MethodInfo methodInfo = typeof(ClassWithNonAsyncMethods).GetParameterlessMethod("PublicDoNothing");
        ...
        [Fact]
        public async Task When_asserting_a_method_is_not_async_but_it_is_then_it_throws_with_a_useful_message()
        {
            // Arrange
            MethodInfo methodInfo = typeof(ClassWithAllMethodsAsync).GetParameterlessMethod("PublicAsyncDoNothing");
        ...
        [Fact]
        public async Task When_subject_is_null_not_be_async_should_fail()
        {
            // Arrange
            MethodInfo methodInfo = null;
