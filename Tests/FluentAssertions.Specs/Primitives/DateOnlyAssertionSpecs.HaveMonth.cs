...
public partial class DateOnlyAssertionSpecs
{
    public class HaveMonth
    {
        ...
        [Fact]
        public async Task When_asserting_subject_dateonly_should_not_have_month_with_the_same_value_it_should_throw()
        {
            // Arrange
            DateOnly subject = new(2009, 12, 31);
            const int expectation = 12;
        ...
        [Fact]
        public async Task When_asserting_subject_dateonly_should_have_a_month_with_a_different_value_it_should_throw()
        {
            // Arrange
            DateOnly subject = new(2009, 12, 31);
        ...
        [Fact]
        public async Task When_asserting_subject_null_dateonly_should_have_month_should_throw()
        {
            // Arrange
        ...
        [Fact]
        public async Task When_asserting_subject_null_dateonly_should_not_have_month_should_throw()
        {
            // Arrange
            DateOnly? subject = null;
            const int expectation = 12;
